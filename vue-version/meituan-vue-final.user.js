...
// @version      1.0
// @description  Meituan store helper with Vue UI (Vue 3 version)
// @author       wither
// @match        https://shangoue.meituan.com/*
// @run-at       document-idle
// @grant        none
// @require      https://unpkg.com/vue@3.4.21/dist/vue.global.js
...
(function () {
    ...
    console.log("Meituan Vue Helper 已注入:", location.href);
    ...
    const MenuComponent = {
        ...
        `,
        setup() {
            const showMenu = window.Vue.ref(false);
            const showDownload = window.Vue.ref(false);
    ...
    const main = async () => {
        ...
        const app = window.Vue.createApp(MenuComponent);
